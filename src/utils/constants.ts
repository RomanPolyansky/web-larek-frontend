...
export enum Events {
  SHOP_ITEMS__CHANGED = 'shop.items:changed',
  SHOP_ITEM__CLICKED = 'shop.item:clicked',
  SHOP_ORDER__CHANGED = "shop.basket:added",
  MODAL__CLOSED = "model:closed",
  SHOP_ORDER__PROCEED = "shop.order:proceed",
  SHOP_ORDER__OPEN = "shop.order:open",
  SHOP_ORDER__ITEM_ADDED = "shop.order:item.added",
  SHOP_ORDER__ITEM_REMOVED = "shop.order:item.removed",
  ORDER_FORM__SUBMITTED_INFO = "order.form:submitted.info",
  ORDER_FORM__SUBMITTED_CONTACTS = "order.form:submitted.contacts",
  ORDER__CLOSED = "ORDER__CLOSED",
}
